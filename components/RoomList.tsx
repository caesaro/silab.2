                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      {(room.facilities?.length || 0) > 3 && (
                        <span className="text-xs text-gray-400 px-2 py-1">+lainnya</span>
                      )}
                    </div>
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100 dark:border-gray-700">
                      <div className="flex space-x-2 w-full">
                        ...
                        <button className="flex-1 px-4 py-2 bg-gray-900 dark:bg-white dark:text-gray-900 text-white text-sm font-medium rounded-lg hover:opacity-90 transition-opacity text-center ml-auto">
                          Detail & 360°
                        </button>
                      </div>
                    </div>
