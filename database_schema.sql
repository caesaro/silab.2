...
CREATE TABLE rooms (
    ...
    google_calendar_id VARCHAR(100),     -- ID Kalender untuk sinkronisasi
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE bookings (
    ...
    proposal_file TEXT,                       -- Path/URL file PDF surat permohonan
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE equipment (
    id VARCHAR(50) PRIMARY KEY,
    name VARCHAR(100) NOT NULL,
    code VARCHAR(50) UNIQUE NOT NULL,    -- Kode Inventaris (misal: PRJ-001)
...
CREATE TABLE loans (
    ...
    return_date DATE NOT NULL,                -- Tanggal rencana kembali
